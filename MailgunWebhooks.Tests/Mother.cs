...
namespace MailgunWebhooks.Tests
{
    public static class Mother
    {
        ...
        public static List<KeyValuePair<string, string>> CreateValidDeliverRequest()
        {
        ...
        public static List<KeyValuePair<string, string>> CreateValidUnsubscribeRequest()
        {
            var identification = GenerateMailgunIdentification("5678", SampleMailgunApiKey);
            return new List<KeyValuePair<string, string>>
            {
                new KeyValuePair<string, string>("message-id", "123"),
                new KeyValuePair<string, string>("message-headers", "some headers"),
